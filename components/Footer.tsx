        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 flex gap-4">
              ...
              <a href="tel:+918168035634" className="text-slate-400 hover:text-gold-400 transition" aria-label="Phone">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-slate-400">
              ...
              <li><a href="tel:+918168035634" className="hover:text-gold-400 transition">+91 81680 35634</a></li>
            </ul>
          </div>
        </div>
