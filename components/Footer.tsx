        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 flex gap-4">
              <a href="mailto:narenderbeniwal1234@gmail.com" className="text-slate-400 hover:text-gold-400 transition" aria-label="Email">
              ...
              <a href="tel:+966501234567" className="text-slate-400 hover:text-gold-400 transition" aria-label="Phone">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-slate-400">
              <li><a href="mailto:narenderbeniwal1234@gmail.com" className="hover:text-gold-400 transition">narenderbeniwal1234@gmail.com</a></li>
              <li><a href="tel:+966501234567" className="hover:text-gold-400 transition">+966 50 123 4567</a></li>
            </ul>
          </div>
        </div>
        <div className="mt-16 border-t border-white/5 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-slate-500">© {new Date().getFullYear()} QuantumBridge Innovations. All rights reserved.</p>
