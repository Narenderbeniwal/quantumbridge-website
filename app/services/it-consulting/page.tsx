...
export const metadata: Metadata = {
  title: 'IT Consulting',
  description:
    'Strategy, digital transformation, and technology roadmaps.',
  openGraph: {
    title: 'IT Consulting – QuantumBridge Innovations',
    description: 'Strategy, digital transformation, and technology roadmaps.',
  },
}
